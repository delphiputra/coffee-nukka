          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="relative">
              <Link href="/pembeli/order">
                <button className="p-2 bg-brownzz-900 text-white rounded-full hover:bg-brown-950">
            ...
            {makanan.map((item) => (
              <div key={item.id} className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                ...
                <button
                  ...
                  className="mt-6 w-full px-4 py-2 bg-brown-700 text-white rounded hover:bg-brown-800 transition"
                >
                  Order Now
                </button>
              </div>
